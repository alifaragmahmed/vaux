...
class AdminSidebarMenu
{
        ...
        Menu::create('admin-sidebar-menu', function ($menu) {
            ...
            if(auth()->user()->can_access_custom('products_main', 'empty')){
                if (auth()->user()->can('product.view') || auth()->user()->can('product.create') ||
                    ...
                    $product_module_name = __('sale.products');
                    $business_type_slug = auth()->user()->business->getBusinessTypeSlug(auth()->user()->business->typeId);
                    if($business_type_slug == 'restaurant'){
                        $product_module_name = __('sale.products_restaurant');
                    }
                    $menu->dropdown(
                        $product_module_name,
                        function ($sub) {
                            if (auth()->user()->can('product.view') && auth()->user()->can_access_custom('products_list')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('product.create') && auth()->user()->can_access_custom('products_add')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('product.view') && auth()->user()->can_access_custom('products_print_labels')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('product.create') && auth()->user()->can_access_custom('products_variations')) {
                                $sub->url(
                                ...
                                if(auth()->user()->can_access_custom('products_import')){
                                    $sub->url(
                            ...
                            if (auth()->user()->can('product.opening_stock') && auth()->user()->can_access_custom('products_import_opening_stock')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('product.create') && auth()->user()->can_access_custom('products_selling_price_group')) {
                                $sub->url(
                            ...
                            if ((auth()->user()->can('unit.view') || auth()->user()->can('unit.create'))  && auth()->user()->can_access_custom('products_units')) {
                                $sub->url(
                            ...
                            if ((auth()->user()->can('category.view') || auth()->user()->can('category.create')) && auth()->user()->can_access_custom('products_categories')) {
                                $sub->url(
                            ...
                            if ((auth()->user()->can('brand.view') || auth()->user()->can('brand.create')) && auth()->user()->can_access_custom('products_brands')) {
                                $sub->url(
                            ...
                            if(auth()->user()->can_access_custom('products_warranties')){
                                $sub->url(
            ...
            if(auth()->user()->can_access_custom('purchases_main', 'empty')){
                ...
                $menu->dropdown(
                    ...
                    function ($sub) {
                        if ((auth()->user()->can('purchase.view') || auth()->user()->can('view_own_purchase')) && auth()->user()->can_access_custom('purchases_list')) {
                            $sub->url(
                        ...
                        if (auth()->user()->can('purchase.create') && auth()->user()->can_access_custom('purchases_add')) {
                            $sub->url(
            ...
            if(auth()->user()->can_access_custom('sells_main', 'empty')) {
                if (auth()->user()->can('sell.view') || auth()->user()->can('sell.create') || auth()->user()->can('direct_sell.access') || auth()->user()->can('view_own_sell_only') || auth()->user()->can('access_sell_return')) {
                    $menu->dropdown(
                        __('sale.sale'),
                        function ($sub) use ($enabled_modules) {
                            if ((auth()->user()->can('direct_sell.access') || auth()->user()->can('view_own_sell_only')) && auth()->user()->can_access_custom('sells_all_sales')) {
                                $sub->url(
                            ...
                            if (in_array('add_sale', $enabled_modules) && auth()->user()->can('direct_sell.access') && auth()->user()->can_access_custom('sells_add_sale')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('sell.view') && auth()->user()->can_access_custom('sells_pos_list')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('sell.create') && auth()->user()->can_access_custom('sells_pos_create')) {
                            ...
                            if (auth()->user()->can('list_drafts') && auth()->user()->can_access_custom('sells_list_drafts')) {
                                $sub->url(
                            ...
                            if (in_array('add_sale', $enabled_modules) && auth()->user()->can('direct_sell.access') && auth()->user()->can_access_custom('sells_add_quotation')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('list_quotations') && auth()->user()->can_access_custom('sells_list_quotations')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('access_sell_return') && auth()->user()->can_access_custom('sells_list_sell_return')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('access_shipping') && auth()->user()->can_access_custom('sells_shipments')) {
                                $sub->url(
                            ...
                            if (in_array('subscription', $enabled_modules) && auth()->user()->can('direct_sell.access') && auth()->user()->can_access_custom('sells_subscrptions')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('sell.create') && auth()->user()->can_access_custom('sells_import_sales')) {
                                $sub->url(
            ...
            $menu->dropdown(
                __('shipping.shippings'),
                function ($sub) {
                        $sub->url(
                            action('ShippingCompanyController@index'),
                            __('shipping.list_shipping_companies'),
                            ['icon' => 'fa fas fa-list', 'active' => request()->segment(1) == 'shipping' && request()->segment(2) == null]
                        );
                },
                ['icon' => 'fa fas fa-arrow-circle-down', 'id' => 'tour_step6']
            )->order(25);
            ...
            if($this->canAccessModule('stock_transfers')){
            ...
            if($this->canAccessModule('stock_adujstments')){
            ...
            //Expense dropdown
            if($this->canAccessModule('expenses')){
                ...
                if (auth()->user()->can('purchase_n_sell_report.view') || auth()->user()->can('contacts_report.view')
                    ...
                    $menu->dropdown(
                        ...
                        function ($sub) use ($enabled_modules) {
                            ...
                            if (config('constants.show_report_606') == true && auth()->user()->can_access_custom('reports_profit_loss')) {
                                $sub->url(
                            ...
                            if (config('constants.show_report_607') == true && auth()->user()->can_access_custom('reports_profit_loss')) {
                                $sub->url(
                            ...
                            if ((in_array('purchases', $enabled_modules) || in_array('add_sale', $enabled_modules) || in_array('pos_sale', $enabled_modules)) && auth()->user()->can('purchase_n_sell_report.view') && auth()->user()->can_access_custom('reports_pruchases_sale')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('tax_report.view') && auth()->user()->can_access_custom('reports_tax')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('contacts_report.view') && auth()->user()->can_access_custom('reports_supplier_customer')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('stock_report.view') && auth()->user()->can_access_custom('reports_stock')) {
                                $sub->url(
                                ...
                                if (session('business.enable_product_expiry') == 1 && auth()->user()->can_access_custom('reports_stock')) {
                                    $sub->url(
                                ...
                                if (session('business.enable_lot_number') == 1 && auth()->user()->can_access_custom('reports_stock')) {
                                    $sub->url(
                                ...
                                if (in_array('stock_adjustment', $enabled_modules) && auth()->user()->can_access_custom('reports_stock_adjustment')) {
                                    $sub->url(
                            ...
                            if (auth()->user()->can('trending_product_report.view') && auth()->user()->can_access_custom('reports_trending_products')) {
                                $sub->url(
                            ...
                            if (in_array('expenses', $enabled_modules) && auth()->user()->can('expense_report.view') && auth()->user()->can_access_custom('reports_expense')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('register_report.view') && auth()->user()->can_access_custom('reports_register')) {
                                $sub->url(
                            ...
                            if (auth()->user()->can('sales_representative.view') && auth()->user()->can_access_custom('reports_sales')) {
                                $sub->url(
            ...
            if($this->canAccessModule('notification_templates')){
    ...
    private function canAccessModule($perm_name){

    ...
    public function index()
    {
        ...
        if (request()->ajax() && request()->content_type != 'html') {
            ...
            return Datatables::of($barcodes)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'BarcodeController@edit\', [$id])}}" class="btn btn-xs btn-primary edit_barcode_button"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>    
                    &nbsp;

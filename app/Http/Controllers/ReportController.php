...
class ReportController extends Controller
{
    ...
    public function saleReports(Request $request)
    {
        ...
        return view('report.pages.sale_report');
    }

    public function stockReport(Request $request)
    {

        return view('report.pages.stock_report');
    }

    public function purchaseReportPage(Request $request)
    {

        return view('report.pages.purchasing_report');
    }

    public function otherReports(Request $request)
    {

        return view('report.pages.other_report');
    }
    ...
    public function getIncomeStatement(Request $request)
    {
        ...
        $start_date = $request->get('start_date') ? $request->get('start_date') : $year . "-01-01";
        $end_date = $request->get('end_date') ? $request->get('end_date') : $year . "-12-31";
        ...
        return view('report.income_statement', compact('business_locations', 'data', 'start_date', 'end_date', 'location_id'));
    }
    ...
    public function getAging(Request $request)
    {
        ...
        return view('report.aging', compact('resources', 'business_locations', 'type'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function getStockReview(Request $request)
    {
        if (!auth()->user()->can('profit_loss_report.view')) {
            abort(403, 'Unauthorized action.');
        }
        ...
        return view('report.stock_review', compact('business_locations', 'data', 'start_date', 'end_date', 'location_id'));
    }
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($report)
                ...
                ->editColumn('product_image', function ($row) {
                    ...
                    return "<img src='" . $product->image_url . "' style='width: 60px;height: 60px;border-radius: 5em' >";
                })
                ->rawColumns(['exp_date', 'ref_no', 'edit', 'stock_left', 'product_image'])
                ->make(true);
        }

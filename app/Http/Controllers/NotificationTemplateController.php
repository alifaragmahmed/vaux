    ...
    public function store(Request $request)
    {
        ...
        foreach ($template_data as $key => $value) { 
            $data = [
                ...
                'email_body' => isset($value['email_body'])? $value['email_body'] : '',
                'sms_body' => isset($value['sms_body'])? $value['sms_body'] : '',
                'whatsapp_text' => isset($value['whatsapp_text'])? $value['whatsapp_text'] : '',
                ...
                'cc' => isset($value['cc'])? $value['cc'] : '',
                'bcc' => isset($value['bcc'])? $value['bcc'] : '',
            ];
        ...
        return responseJson(1, __('business.settings_updated_success'));

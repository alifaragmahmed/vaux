    ...
    public function index()
    {
        ...
        if (request()->ajax() && request()->content_type != 'html') {
            ...
            return Datatables::of($locations)
                ->addColumn(
                    'action',
                    '<button type="button" data-href="{{action(\'BusinessLocationController@edit\', [$id])}}" class="btn btn-xs btn-primary btn-modal edit-button" data-container=".location_edit_modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $output = [
                'success' => true,
                'status' => 1,
                'message' => __('business.business_location_updated_success'),

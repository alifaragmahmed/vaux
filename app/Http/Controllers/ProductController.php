...
use App\Jobs\WooProductCreatedJob;
...
class ProductController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($products)
                ...
                ->editColumn('image', function ($row) {
                    return '<div style="display: flex;width: 100px"><img src="' . $row->image_url . '" alt="Product image" class="product-thumbnail-small"></div>';
                })
                ->editColumn('type', '@lang("lang_v1." . $type)')
                ->addColumn('mass_delete', function ($row) {
                    return  '<input type="checkbox" style="width: 50px" class="row-select" value="' . $row->id .'">' ;
                })
    ...
    public function update(Request $request, $id)
    {
        ...
        */
        ...
        return responseJson(1, __('product.product_updated_success'), $product);
        //return redirect('products')->with('status', $output);
    }
    ...
    public function saveSellingPrices(Request $request)
    {
        ...
        try {
            ...
            return responseJson(0, __("messages.something_went_wrong"), null);
        }
        ...
        return responseJson(1, __("lang_v1.updated_success"), $product);
        //return redirect('products')->with('status', $output);
    }

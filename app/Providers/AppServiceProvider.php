...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        //Blade can_bt
        Blade::if('can_bt', function ($permission) {
            return can_bt($permission);
        });
        ...
        //Blade directive to define access module
        Blade::if('canaccessmodule', function ($module, $business_id = null) {
            return canAccessModule($module, $business_id);
        });

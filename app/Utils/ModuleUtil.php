...
class ModuleUtil extends Util
{
     ...
     * @return array
     */
    public function getPOSModuleData()
    {
        $parents = DB::table('pos_modules')->where('parent', 0)->orderBy('sort_order', 'asc')->get()->toArray();
        foreach($parents as &$parent){
            $parent->sub_modules = DB::table('pos_modules')->where('parent', $parent->id)->orderBy('sort_order', 'asc')->get()->toArray();
        }
        return $parents;
    }

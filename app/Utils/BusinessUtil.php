...
class BusinessUtil extends Util
{
    ...
    public function createNewBusiness($business_details)
    {
        ...
        // add type id
        $business_details['typeId'] = request()->businesstype_id;
    ...
    public function addLocation($business_id, $location_details, $invoice_scheme_id = null, $invoice_layout_id = null)
    {
        ...
        $location = BusinessLocation::create(['business_id' => $business_id,
                            ...
                            'landmark' => isset($location_details['landmark'])? $location_details['landmark'] : '-',
                            'city' => isset($location_details['city'])? $location_details['city'] : '-',
                            'state' => isset($location_details['state'])? $location_details['state'] : '-',
                            'zip_code' => isset($location_details['zip_code'])? $location_details['zip_code'] : '-',
                            'country' => isset($location_details['country'])? $location_details['country'] : '-',

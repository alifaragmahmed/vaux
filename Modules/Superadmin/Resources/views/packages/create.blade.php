...
<section class="content">
	...
	{!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\PackagesController@store'), 'method' => 'post', 'id' => 'add_package_form' ,'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="col-md-9">
            				@foreach($module->sub_modules as $permission)
                                <div class="col-md-12 w3-padding">
                                    <div class="checkbox">
                                        <label>
                						{!! Form::checkbox("custom_permissions[$permission->slug]", 1, $permission->default_shown, ['class' => 'input-icheck']); !!}
                                        {{$permission->name}}
                                        </label>
                                    </div>
                                </div>

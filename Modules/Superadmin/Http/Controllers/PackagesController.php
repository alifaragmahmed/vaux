...
class PackagesController extends BaseController
{
    ...
    public function create()
    {
        ...
        $permissions = $this->moduleUtil->getModuleData('superadmin_package');
        $permissions_pos = $this->moduleUtil->getPOSModuleData();

        return view('superadmin::packages.create')
            ->with(compact('intervals', 'currency', 'permissions', 'permissions_pos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only([
                'name', 'description', 'location_count', 
            ...
            if ($request->hasFile('image')) {
                $filename = uploadImg($request->file('image'), "uploads/packages/", function($filename)  {
                    //
                }); 
                $input['image'] = "/uploads/packages/" . $filename;  
            }
    ...
    public function edit($id)
    {
        ...
        return view('superadmin::packages.edit')
            ->with(compact('packages', 'intervals', 'permissions', 'permissions_pos'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $packages_details = $request->only([
                'name', 'id', 'description', 'location_count', 
                'user_count', 'product_count', 'invoice_count', 
                'interval', 'interval_count', 'trial_days', 
                'price', 'sort_order', 'is_active', 'custom_permissions', 
                'is_private', 'is_one_time', 
                'enable_custom_link', 
                'business_type_id',
            ...
            if ($request->hasFile('image')) {
                ...
                $packages_details['image'] = "/uploads/packages/" . $filename;   
            }

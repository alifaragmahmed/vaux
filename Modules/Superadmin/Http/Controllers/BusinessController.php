...
class BusinessController extends BaseController
{
    ...
    public function create()
    {
       ...
       // $business_types = $this->businessUtil->allBusinessTypes();
    ...
    public function store(Request $request)
    {
        ...
        try {
           ...
           $owner_details = $request->only(['surname', 'first_name', 'last_name', 'username', 'email', 'password']);
            ...
            $business_details = $request->only(['name', 'start_date', 'currency_id', 'tax_label_1', 'tax_number_1', 'tax_label_2', 'tax_number_2', 'time_zone', 'accounting_method', 'fy_start_month', 'typeId']);

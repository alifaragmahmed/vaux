...
class WoocommerceWebhookController extends Controller
{
     ...
     * @return Response
     */
    public function productCreated(Request $request, $business_id)
    {
        ...
        try {
            ...
            $is_valid_request = $this->isValidWebhookRequest($request, $business->woocommerce_wh_pc_secret);
            // dd($is_valid_request);
            ...
            if (!$is_valid_request) {
                ...
                $product_data = json_decode($payload);

                DB::beginTransaction();
                $created = $this->woocommerceUtil->createProduct($business_id, $user_id, $product_data, $business_data);
                
                // dd($created);
                // Log::error(json_encode($created->toArray()));

                // $create_error_data = $created !== true ? $created : [];
                // $created_data[] = $created->sku;

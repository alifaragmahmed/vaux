...
class WoocommerceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('woocommerce::woocommerce.index', compact('tax_rates', 'woocommerce_tax_rates', 'alerts'));
    }
    ...
    {
        // Step 1 add product attributes
        // Step 2 add product variations
        // Step 3 add variations relations with two attributes
        $notAllowed = $this->woocommerceUtil->notAllowedInDemo();
        if (!empty($notAllowed)) {
            return $notAllowed;
        }

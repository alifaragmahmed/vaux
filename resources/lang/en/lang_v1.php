<?php return [
 "msg_of_stock_alert_notification" => "warning {product} in {location} with stock left {stock} will expire in {expire}",
 "msg_of_product_alert_notification" => "warning {product} in {location} is {stock}",

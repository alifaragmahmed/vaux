...
@section('content')
    ...
    <section class="content-header ">
        <h1 class="w3-text-gray">@lang('sale.products')
        </h1>
    </section>
    ...
    <section class="content">
        ...
        @can('product.view')
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link w3-round w3-large first-nav product-nav" style="background: transparent;border-radius: 4px!important;"
                        onclick="$('.tab-pane').hide();$('#product_list_tab').show()" id="pills-home-tab"
                        href="#product_list_tab" data-toggle="tab" aria-expanded="true">
                        @lang('lang_v1.all_products')</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link w3-round w3-large stock-nav" style="background: transparent;border-radius: 4px!important;"
                        onclick="$('.tab-pane').hide();$('#product_stock_report').show();editDatatable()" id="pills-profile-tab"
                        href="#product_stock_report" data-toggle="tab" aria-expanded="true" aria-controls="pills-profile"
                        aria-selected="false">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom w3-round-xlarge">

                        <div class="tab-content w3-round-xlarge w3-card">
                            <div class="tab-pane active w3-display-container" id="product_list_tab">
                                @can('product.create')
                                    <div class="w3-display-topright w3-padding">
                                        <a class="add_btn" style="float: none" href="{{ action('ProductController@create') }}">
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        @if(request()->type)
        $('.{{ request()->type }}-nav').click();
        setTimeout(()=>{
            $('.{{ request()->type }}-table .buttons-excel').click(); 
        }, 500);
        @else
        $('.first-nav').click();
        @endif

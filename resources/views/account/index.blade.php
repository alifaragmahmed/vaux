            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <br>
                                <div class="table-responsive w3-light-gray">
                                    <table data-title="@lang('account.accounts')" class="table table-bordered table-striped" id="other_account_table">
                                        <thead>
                                            <tr>
                    ...
                    <div class="tab-pane" id="account_types">
                        ...
                        <br>
                        <div class="row">
                            <div class="col-md-12 w3-light-gray">
                                <table data-title="@lang('lang_v1.account_types')" class="table table-striped table-bordered" id="account_types_table" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>@lang( 'lang_v1.name' )</th>
                                            <th>@lang( 'messages.action' )</th>

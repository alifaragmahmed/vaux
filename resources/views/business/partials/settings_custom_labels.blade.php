<div class="pos-tab-content">
    ...
    <ul class="w3-ul">
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@lang('lang_v1.labels_for_custom_payments'):</div>

            <div class="w3-display-topright w3-padding">
                <i class="btn fas fa-arrow-circle-right new-theme-text setting-toggle" 
                onclick="$('.field-content').slideUp(500);$(this).parent().parent().find('.field-content').slideDown(500)" ></i>
            </div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@lang('lang_v1.labels_for_contact_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@lang('lang_v1.labels_for_product_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@lang('lang_v1.labels_for_location_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@lang('lang_v1.labels_for_user_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@lang('lang_v1.labels_for_purchase_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@lang('lang_v1.labels_for_sell_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@lang('lang_v1.labels_for_sale_shipping_custom_fields'):</div>
        ...
        <li class="w3-display-container w3-padding w3-margin-bottom" >
            <div class="w3-large custom-setting-title">@lang('lang_v1.labels_for_types_of_service_custom_fields'):</div>

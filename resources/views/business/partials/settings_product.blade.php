<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-sm-6 @if (!$business->enable_product_expiry) hide @endif" id="on_expiry_div">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 enable_sub_category @if ($business->enable_category != 1) hide @endif">
            <div class="form-group">
                <div class="checkbox">
                    <label>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('common_settings[enable_product_warranty]', 1, !empty($common_settings['enable_product_warranty']) ? true : false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.enable_product_warranty') }}
                    </label>
                </div>
            </div>
        </div>

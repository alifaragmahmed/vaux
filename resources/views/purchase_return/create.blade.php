...
<section class="content no-print">
	...
	<div class="box box-solid w3-padding">
		<div class="box-header">
        	<div class="text-center w3-xlarge">{{ __('stock_adjustment.search_products') }}</div>
       	</div>
		<div class="box-body">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="text-center"><b>@lang('stock_adjustment.total_amount'):</b> <span id="total_return">0.00</span></div>
				</div>
			</div>
		</div>
	</div> <!--box end-->
	<div class="">
		<div class="text-center">
			...
			type="button" 
			style="float: none"
			id="submit_purchase_return_form" 
			class="add_btn">@lang('messages.submit')</button>
		</div>
	</div>
	{!! Form::close() !!}
</section>

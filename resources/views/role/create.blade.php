                    ...
                    <div class="permission-content" style="height: 450px;overflow: auto">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'role.user' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'user.roles' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'role.supplier' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'supplier.view', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_all_supplier') }}
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'supplier.view_own', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_own_supplier') }}
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'role.customer' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'customer.view', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_all_customer') }}
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'customer.view_own', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_own_customer') }}
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'business.product' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        @if (in_array('purchases', $enabled_modules) || in_array('stock_adjustment', $enabled_modules))
                            <div class="row check_group">
                                <div class="col-md-2">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" class="check_all input-icheck"> @lang( 'role.purchase' )
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'purchase.view', false, ['class' => 'input-icheck']) !!} {{ __('role.purchase.view') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'sale.pos_sale' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'sale.sale' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                                @if (in_array('add_sale', $enabled_modules))
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'direct_sell.access', false, ['class' => 'input-icheck']) !!} {{ __('role.direct_sell.access') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'list_drafts', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.list_drafts') }}
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'list_quotations', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.list_quotations') }}
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'view_own_sell_only', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_own_sell_only') }}
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'access_sell_return', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.access_sell_return') }}
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'lang_v1.shipments' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang(
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'role.brand' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'role.tax_rate' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'role.unit' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'category.category' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'role.report' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row check_group">
                            <div class="col-md-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" class="check_all input-icheck"> @lang( 'role.settings' )
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-9">
                                ...
                                @if (in_array('expenses', $enabled_modules))
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'expense.access', false, ['class' => 'input-icheck']) !!} {{ __('role.expense.access') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <div class="row check_group">
                            <div class="col-md-9">
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'dashboard.data', true, ['class' => 'input-icheck']) !!} @lang( 'role.dashboard' )
                        ...
                        <div class="row check_group">
                            <div class="col-md-9">
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'account.access', false, ['class' => 'input-icheck']) !!} @lang( 'account.account' )
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if (in_array('booking', $enabled_modules))
                            <div class="row check_group">
                                <div class="col-md-2">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" class="check_all input-icheck"> @lang( 'restaurant.bookings'
                                            )
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'crud_all_bookings', false, ['class' => 'input-icheck']) !!} {{ __('restaurant.add_edit_view_all_booking') }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <label>
                                                {!! Form::checkbox('permissions[]', 'crud_own_bookings', false, ['class' => 'input-icheck']) !!} {{ __('restaurant.add_edit_view_own_booking') }}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <label>
                                            {!! Form::checkbox('permissions[]', 'access_default_selling_price', true, ['class' => 'input-icheck']) !!} @lang( 'lang_v1.access_selling_price_groups' )
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">
                    <div class="w3-padding">
                        <center class="w3-padding">
                            <button type="submit" style="float: inherit" class="add_btn">@lang( 'messages.save' )</button>
                        </center>
                    </div>
                </div>
            </div>

            ...
            <div class="permission-content" style="height: 450px;overflow: auto" >
              <div class="row check_group"> 
                ...
                <div class="col-md-2">
                  <div class="checkbox">
                      <label>
                        <input type="checkbox" class="check_all input-icheck" > @lang( 'cash_register.cash_register' )
                      </label>
                    </div>
                </div>
                <div class="col-md-9">
                  ...
                  <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        ...
                        [ 'class' => 'input-icheck']); !!} @lang( 'role.dashboard' )
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        ...
                        [ 'class' => 'input-icheck']); !!} @lang( 'account.account' )
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-12">
                    <div class="checkbox">
                      <label>
                        ...
                        [ 'class' => 'input-icheck']); !!} @lang( 'lang_v1.access_selling_price_groups' )
                      </label>
                    </div>
                  </div>
                      ...
                      <div class="col-md-12">
                        <div class="checkbox">
                          <label>
                            ...
                            [ 'class' => 'input-icheck']); !!} @lang( 'restaurant.restaurant' )
                          </label>
                        </div>
                      </div>
                    </div>
          ...
          <div class="col-lg-12">
              <div class="w3-padding">
                  <center class="w3-padding">
                      <button type="submit" style="float: inherit" class="add_btn">@lang( 'messages.update' )</button>
                  </center>
              </div>
          </div>

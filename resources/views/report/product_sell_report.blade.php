            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-pills  setting-tabs w3-block w3-padding">
                    <li class="nav-item active" onclick="editDatatable()" >
                        <a class="nav-link" href="#psr_detailed_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list" aria-hidden="true"></i> @lang('lang_v1.detailed')</a>
                    </li>
                    <li class="nav-item" onclick="editDatatable()" >
                        <a class="nav-link" href="#psr_detailed_with_purchase_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list" aria-hidden="true"></i> @lang('lang_v1.detailed_with_purchase')</a>
                    </li>
                    <li class="nav-item" onclick="editDatatable()" >
                        <a class="nav-link" href="#psr_grouped_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-bars" aria-hidden="true"></i> @lang('lang_v1.grouped')</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="psr_detailed_tab">
                        <div class="table-responsive w3-light-gray">
                            <table data-title="@lang('lang_v1.detailed')" class="table table-bordered table-striped" 
                    ...
                    <div class="tab-pane" id="psr_detailed_with_purchase_tab">
                        <div class="table-responsive w3-light-gray">
                            ...
                            @endif
                            <table data-title="@lang('lang_v1.detailed_with_purchase')" class="table table-bordered table-striped" 
                    ...
                    <div class="tab-pane" id="psr_grouped_tab">
                        <div class="table-responsive w3-light-gray">
                            <table data-title="@lang('lang_v1.grouped')" class="table table-bordered table-striped" 

...
<li class="dropdown notifications-menu">
  <a href="#" class="dropdown-toggle load_notifications" data-toggle="dropdown" id="show_unread_notifications" data-loaded="false">
    ...
    <span class="label label-warning notifications_count hidden">@if(!empty($total_unread)){{$total_unread}}@endif</span>
    <span class="label label-warning notifications_count">{{$total_unread}}</span>
  </a>

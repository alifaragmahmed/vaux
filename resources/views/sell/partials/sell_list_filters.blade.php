...
<div class="col-md-3">
    <div class="form-group">
        ...
        {!! Form::text('sell_list_filter_date_range', null, ['placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control w3-white', 'readonly']); !!}
    </div>
</div>
@endif
...
@if(!empty($companies))
    <div class="col-md-3">
        <div class="form-group">
            {!! Form::label('shipping_company', __('shipping.shipping_company') . ':') !!}
            {!! Form::select('shipping_company', $companies, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
        </div>
    </div>
@endif

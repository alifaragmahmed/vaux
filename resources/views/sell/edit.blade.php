...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid w3-padding'])
				...
				<div class="col-md-4 @if(!empty($commission_agent)) c @else c @endif">
					<div class="form-group">
					...
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-btn">
								...
								class="btn btn-default add_select_btn w3-round btn-modal new-theme" data-toggle="modal" 
								data-target="#configure_search_modal" title="{{__('lang_v1.configure_product_search')}}">
								<i class="fa fa-barcode w3-text-white"></i></button>
							</div>
							...
							<span class="input-group-btn">
								...
								data-href="{{action('ProductController@quickAdd')}}" data-container=".quick_add_product_modal">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="pr-card">
							...
							<div class="w3-block text-center"><br>
	...
	<div class="">
		<center class="">
	    	...
	    	<button type="button" class="add_btn" id="submit-sell">@lang('messages.update')</button>
	    	<button type="button" id="save-and-print" style="widows: 220px" class="add_btn">@lang('lang_v1.update_and_print')</button>
	    </center>
	</div>
	@if(in_array('subscription', $enabled_modules))
...
@section('javascript')
	...
	<!-- Call restaurant module _if defined -->

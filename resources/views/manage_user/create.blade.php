...
@section('content')
    <section class="add_user_content add_user_page w3-padding">
        ...
        <h2 class="intro-y text-lg font-medium mt-10 title_bordered">Add User</h2>
        ...
        <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="form">
                        ...
                        <div class="form-group">
                            <label class="customcheck">
                                ...
                                {!! Form::checkbox('is_active', 'active', true, ['class' => 'customcheck']) !!}
                ...
                <div class="panel">
                    <div class="form">
                        <div class="my-3">
                            ...
                            <div class="input-icons">
                                <i class="fa fa-user input_icon"></i>
                                {!! Form::text('username', null, ['class' => 'form-control form-control-rounded', 'placeholder' => __('business.username')]) !!}
                            </div>
                        </div>
                        <div class="my-3">
                            ...
                            <div class="input-icons">
                                ...
                                {!! Form::password('password', ['class' => 'form-control form-control-rounded', 'required', 'placeholder' => __('business.password')]) !!}
                            </div>
                        </div>
                        <div class="my-3">
                            ...
                            <div class="input-icons">
                                <i class="fa fa-user input_icon"></i>
                                {!! Form::password('confirm_password', ['class' => 'form-control form-control-rounded', 'required', 'placeholder' => __('business.confirm_password')]) !!}
                            </div>
                        </div>
                        ...
                        <div class="my-3">
                            <div class="input-icons">
                                ...
                                {!! Form::select('role', $roles, null, ['class' => 'custom-select border_select']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="customcheck">
                                ...
                                {!! Form::checkbox('allow_login', 1, true, ['class' => 'customcheck', 'id' => 'allow_login']) !!}
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        <div class="my-3">
                            ...
                            <div class="col-md-8 col-12">
                                <div class="form-check inner_checks">
                                    <label class="customcheck">
                                        ...
                                        {!! Form::checkbox('access_all_locations', 'access_all_locations', true, ['class' => 'input-icheck']) !!}
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <label class="customcheck">{{ __('lang_v1.allow_selected_contacts') }}
                                        ...
                                        {!! Form::checkbox('selected_contacts', 1, false, ['class' => 'checkbox1', 'id' => 'selected_contacts']) !!}
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div id="autoUpdate" class="autoUpdate" style="display: none">
                                        ...
                                        {!! Form::select('selected_contact_ids[]', $contacts, null, ['class' => 'form-control mySelect', 'multiple']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="tab-pane fade" id="tab_4" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="panel">
                    <div class="form row">
                        @include('user.form')
                    </div>

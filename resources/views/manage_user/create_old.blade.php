...
<section class="content">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::text('email', null, ['class' => 'form-control', 'required', 'placeholder' => __(
                    'business.email' ) ]); !!}
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {!! Form::text('username', null, ['class' => 'form-control', 'placeholder' => __(
                            'business.username' ) ]); !!}
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    {!! Form::text('max_sales_discount_percent', null, ['class' => 'form-control input_number',
            ...
            <div class="col-sm-4 hide selected_contacts_div">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        {!! Form::select('selected_contact_ids[]', $contacts, null, ['class' => 'form-control select2',
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="submit" class="btn btn-primary pull-right" id="submit_user_button">@lang( 'messages.save'
                )</button>
        </div>
    </div>
    {!! Form::close() !!}

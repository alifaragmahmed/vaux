      ...
      <div class="row">
        <div class="option-div-group">
          <div class="col-sm-6">
            <div class="form-group">
              <div class="w3-display-container option-div @if($invoice->scheme_type == 'blank') {{ 'active'}} @endif">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="w3-display-container option-div  @if($invoice->scheme_type == 'year') {{ 'active'}} @endif">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="input-  col-md-12 col-sm-12"> 
                @php
                  $disabled = '';

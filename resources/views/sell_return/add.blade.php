...
{!! Form::hidden('location_id', $sell->location->id, ['id' => 'location_id', 'data-receipt_printer_type' => $sell->location->receipt_printer_type ]); !!}
	...
	<div class="box box-solid w3-padding w3-round w3-white">
		...
		<div class="box-body">
			...
			<div class="row">
				@php
					...
					$reason_notes = !empty($sell->return_parent->reason_notes) ? $sell->return_parent->reason_notes : $sell->reason_notes;
				@endphp
				<div class="col-sm-4">
					<div class="form-group">
				...
				<div class="col-sm-4">
					<div class="form-group">
						{!! Form::label('reason_notes', __( 'reason_notes' ) . ':') !!}
						{!! Form::textarea('reason_notes', $reason_notes, ['class' => 'form-control']); !!}
					</div>
				</div>
			</div>
			@php

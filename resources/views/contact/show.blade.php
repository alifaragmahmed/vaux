...
<section class="content no-print">
    ...
    <div class="hide print_table_part">
        ...
        <div class="contact-attr" style="width: 100%;">
            <div class="info_col">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-solid">
                <div class="box-body contact-info-row">
                ...
                <ul class="nav nav-pills mb-3 setting-tabs w3-padding">
                    ...
                    class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                        <a class="nav-link " href="#ledger_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-scroll" aria-hidden="true"></i> @lang('lang_v1.ledger')</a>
                    </li>
                        ...
                        onclick="editDatatable()" 
                         class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                            <a class="nav-link " href="#purchases_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-arrow-circle-down" aria-hidden="true"></i> @lang( 'purchase.purchases')</a>
                        </li>
                        <li
                        onclick="editDatatable()" 
                         class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                            <a class="nav-link " href="#stock_report_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-hourglass-half" aria-hidden="true"></i> @lang( 'report.stock_report')</a>
                        </li>
                    @endif
                        ...
                        onclick="editDatatable()" 
                         class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                            <a class="nav-link " href="#sales_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-arrow-circle-up" aria-hidden="true"></i> @lang( 'sale.sells')</a>
                        </li>
                            ...
                            onclick="editDatatable()" 
                             class="nav-item
                                ...
                                @else
                                    ''
                                @endif">
                                <a class="nav-link " href="#subscriptions_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-recycle" aria-hidden="true"></i> @lang( 'lang_v1.subscriptions')</a>
                            </li>
                        @endif
                    @endif
                    <li
                    onclick="editDatatable()" 
                     class="nav-item
                            ...
                            @endif
                            ">
                        <a class="nav-link " href="#documents_and_notes_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-paperclip" aria-hidden="true"></i> @lang('lang_v1.documents_and_notes')</a>
                    </li>
                    <li
                    onclick="editDatatable()" 
                     class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                        <a  class="nav-link " href="#payments_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-money-bill-alt" aria-hidden="true"></i> @lang('sale.payments')</a>
                    </li>
                        ...
                        onclick="editDatatable()" 
                         class="nav-item
                            ...
                            @else
                                ''
                            @endif">
                            <a class="nav-link " href="#reward_point_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-gift" aria-hidden="true"></i> {{ session('business.rp_name') ?? __( 'lang_v1.reward_points')}}</a>
                        </li>
                    @endif
                    ...
                    onclick="editDatatable()" 
                     class="nav-item
                        ...
                        @else
                            ''
                        @endif">
                        <a class="nav-link " href="#activities_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-pen-square" aria-hidden="true"></i> @lang('lang_v1.activities')</a>
                        </li>
                        ...
                        <br>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table data-title="activity log" class="table table-bordered table-striped" 

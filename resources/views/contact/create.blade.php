    ...
    <div class="modal-body">
        <div class="row">            
            <div class="col-md-4 contact_type_div">
                <div class="form-group">
                    ...
                    <div class="input- "> 
                        {!! Form::select('type', $types, $type , ['class' => 'form-control', 'id' => 'contact_type','placeholder' => __('messages.please_select'), 'required', 'disabled']); !!}
                    </div>
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <button type="button" class="btn btn-primary center- more_btn" data-target="#more_div">@lang('lang_v1.more_info') <i class="fa fa-chevron-down"></i></button>
            </div>

...
<section class="content no-print">
	...
	<div class="box box-solid w3-padding">
		<div class="box-header">
        	<div class="text-center w3-xlarge w3-padding">{{ __('stock_adjustment.search_products') }}</div>
       	</div>
		<div class="box-body">
			<div class="row">
				<div class="col-sm-8">
			...
			<div class="text-left">
				<div class=""><b>@lang('stock_adjustment.total_amount'):</b> <span id="total_adjustment">0.00</span></div>
			</div>
		</div>
	</div> <!--box end-->
	<div class="box box-solid w3-padding">
	...
	<div class="">
		<div class="text-center w3-padding">
			<button type="submit" id="save_stock_transfer" class="add_btn">@lang('messages.save')</button>
		</div>
	</div>
	{!! Form::close() !!}
</section>

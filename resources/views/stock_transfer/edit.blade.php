...
<section class="content no-print">
	...
	<div class="box box-solid w3-padding">
		<div class="box-header">
        	<div class="w3-padding w3-xlarge text-center">{{ __('stock_adjustment.search_products') }}</div>
       	</div>
		<div class="box-body">
			<div class="row">
				<div class="col-sm-8 ">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="text-left">
						<div class=""><b>@lang('stock_adjustment.total_amount'):</b> <span id="total_adjustment">{{@num_format($subtotal)}}</span></div>
					</div>
	...
	<div class="">
		<div class="text-center w3-padding">
			<button 
				...
				class="add_btn">@lang('messages.save')
			</button>
		</div>
	</div>
	{!! Form::close() !!}

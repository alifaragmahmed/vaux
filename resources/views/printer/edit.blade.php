  ...
  <div class="modal-content">
    ...
    <section class="content">
      <div class="modal-header ">
          ...
          <h4 class="modal-title">{{ __('printer.edit_printer_setting') }}</h4>
      </div>
      <div class="box- box-solid">
        <div class="box--body">
          <div class="row">
            ...
            <div class="col-sm-12">
              <button type="submit" id="add_printer_form" class="btn btn-primary pull-right">@lang('messages.update')</button>
            </div>
          </div>
        </div>
      </div>

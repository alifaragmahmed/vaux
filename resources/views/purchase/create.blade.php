...
<section class="content">
			...
			<div class="col-sm-12">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 w3-padding">
						@lang( 'lang_v1.total_items' ): <span id="total_quantity" class="display_currency" data-currency_symbol="false"></span>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 w3-padding">
						@lang( 'purchase.net_total_amount' ): <span id="total_subtotal" class="display_currency"></span>
		...
		<div class="w3-padding">
			<div class="row">
				<div class="col-lg-12 text-center">
					<b class="w3-large w3-text-gray">@lang( 'purchase.discount' )</b>
					<br>
				</div>
	...
	<center class="w3-padding" >
		<button type="button" id="submit_purchase_form" style="float: none" class="btn btn-primary add_btn">@lang('messages.save')</button>
	</center>

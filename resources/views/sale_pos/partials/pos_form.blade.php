<div class="w3-padding">
		...
		<div class="col-md-6 w3-padding">
			<div class="form-group">
				<div class="input-group"> 
					...
					<button type="button" style="padding: 9px;border-radius: 6px" class="btn w3-green btn-default btn-flat" data-toggle="modal" data-target="#configure_search_modal" title="{{__('lang_v1.configure_product_search')}}"><i class="fa fa-barcode"></i></button>
					</span>
					...
					<span class="input-group-btn">
						...
						@if(isset($pos_settings['enable_weighing_scale']) && $pos_settings['enable_weighing_scale'] == 1)
							<button style="padding: 9px;border-radius: 6px" type="button" class="btn btn-default  w3-green btn-flat" id="weighing_scale_btn" data-toggle="modal" data-target="#weighing_scale_modal" 
							title="@lang('lang_v1.weighing_scale')"><i class="fa fa-digital-tachograph fa-lg"></i></button>
						@endif
						
	
						<button type="button" style="padding: 9px;border-radius: 6px" class="btn btn-default w3-green btn-flat pos_add_quick_product" data-href="{{action('ProductController@quickAdd')}}" data-container=".quick_add_product_modal"><i class="fa fa-plus-circle fa-lg"></i></button>
					</span>
				</div>
			</div>
		</div>
			...
			<div class="form-group">
				<div class="input-group">
					...
					{!! Form::select('contact_id', 
					 ...
					 <span class="input-group-addon  w3-green w3-round" style="padding: 0px" >
	...
	<div class="row">
		...
		@if(!empty($pos_settings['enable_transaction_date']))
			<div class="col-md-4 col-sm-6 w3-padding">
				<div class="form-group">
					<div class="input-">
						<span class="input-group-addon hidden">
		...
		@if(in_array('tables' ,$enabled_modules) || in_array('service_staff' ,$enabled_modules))
			...
			<span class="col-md-8 col-sm-12 w3-padding" id="restaurant_module_span">

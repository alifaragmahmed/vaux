...
<section class="content no-print">
    ...
    @component('components.widget', ['class' => 'box-primary w3-padding w3-display-container'])
        
            <div class="w3-display-topright">
                <a class="add_btn" style="width: 200px" href="{{action('SellController@create', ['status' => 'draft'])}}">
        ...
        <div class="table-responsive w3-light-gray">
            <table data-title="@lang('sale.drafts')" 
            class="table table-bordered table-striped ajax_view" id="sell_table">
                <thead>
                    <tr>

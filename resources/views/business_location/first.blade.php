...
{!! Form::open(['url' => action('BusinessLocationController@update', [$location->id]), 'method' => 'PUT', 'class' => 'form', 'id' => 'business_location_add_form']) !!}
...
<div class="modal-footer text-center w3-center">
    <button type="submit" style="margin: auto" class="add_btn">@lang( 'messages.save' )</button>
</div>

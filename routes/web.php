...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'CheckUserLogin'])->group(function () {
    ...
    Route::resource('business_types', 'BussinessTypeController');
    Route::get('business_types/permissions/{resource}', 'BussinessTypeController@permission');
    Route::post('business_types/updatePermission/{resource}', 'BussinessTypeController@updatePermission');
    ...
    //Reports main pages
    Route::get('/reports/pages/sale-report', 'ReportController@saleReports');
    Route::get('/reports/pages/stock-report', 'ReportController@stockReport');
    Route::get('/reports/pages/purchase-report', 'ReportController@purchaseReportPage');
    Route::get('/reports/pages/other-report', 'ReportController@otherReports');
    ...
    Route::get('/reports/income-statement', 'ReportController@getIncomeStatement');
    Route::get('/reports/aging', 'ReportController@getAging');
    ...
    Route::group(['prefix' => 'shipping'], function () {
        ...
        Route::resource('{company}/settlement', 'ShippingSettlementController');
        Route::post('settlement/bulk', 'ShippingSettlementController@settleBulk')->name('shipping.settle.bulk');

        Route::get('{company}/fees', 'ShippingFeesController@index');
        Route::get('{company}/fees/create', 'ShippingFeesController@create');
        Route::post('{company}/fees', 'ShippingFeesController@store');
        Route::get('{company}/fees/{id}/edit', 'ShippingFeesController@edit');
        Route::put('{company}/fees/{id}', 'ShippingFeesController@update');
        Route::delete('{company}/fees/{id}', 'ShippingFeesController@destroy');

        Route::get('{company}/fees/{id}', 'ShippingFeesController@getDeliveryFees')->name('getDelivery.fees');
    });
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get ('/delete/{id}', 'PurchaseController@destroy');

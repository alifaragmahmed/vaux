...
function __currency_trans_from_en(
    ...
    var amount_rounding_method = $('#amount_rounding_method_input').val();
    //precision = parseInt(amount_rounding_method) - 1;


    console.log('input, symbol, precision, thousand, decimal, format', input, symbol, precision, thousand, decimal, format);

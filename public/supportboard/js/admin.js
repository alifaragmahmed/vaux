    ...
    $(document).ready(function () {
        ...
        $(conversations_area).on('click', '#conversation-department li', function (e) {
            ...
            if (!select.sbLoading()) dialog(`${sb_('All agents assigned to the new department will be notified. The new department will be')} ${$(this).html()}.`, 'alert', () => {
                ...
                SBConversations.assignDepartment(SBChat.conversation.id, $(this).data('id'), () => {
                    SBConversations.setActiveDepartment($(this).data('id'));
        ...
        */
        ...
        $(profile_edit_box).on('click', '.sb-save', function () {
            ...
            if (SBProfile.errors(profile_edit_box)) {
                SBProfile.showErrorMessage(profile_edit_box, ['agent', 'admin'].includes(profile_edit_box.find('#user_type :selected').val()) || profile_edit_box.hasClass('sb-user-new') ? 'First name, last name, and a valid email are required.' : 'First name and last name are required.');
                $(this).sbLoading(false);
                return;
            }
        ...
        */
        ...
        $(settings_area).on('click', '#dialogflow-button .sb-btn', function (e) {
            ...
            } else window.open('https://board.support/synch/?service=dialogflow&plugin_url=' + SB_URL + cloudURL());
            e.preventDefault();
            return false;
        });
